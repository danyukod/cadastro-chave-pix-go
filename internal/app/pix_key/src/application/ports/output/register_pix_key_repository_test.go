...
type PixKeyPersistenceMock struct {
	PixKeyPersistenceInterface
	findPixKeyByKeyAndTypeFunc func(pixKeyType string, pixKey string) (domain.PixKeyDomainInterface, error)
	createPixKeyFunc           func(pixKeyDomain domain.PixKeyDomainInterface) (domain.PixKeyDomainInterface, error)
}

func (p PixKeyPersistenceMock) FindPixKeyByKeyAndType(pixKeyType string, pixKey string) (domain.PixKeyDomainInterface, error) {
	return p.findPixKeyByKeyAndTypeFunc(pixKeyType, pixKey)
}

func (p PixKeyPersistenceMock) CreatePixKey(pixKeyDomain domain.PixKeyDomainInterface) (domain.PixKeyDomainInterface, error) {
